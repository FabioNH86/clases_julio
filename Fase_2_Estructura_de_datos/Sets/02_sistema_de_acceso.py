# RETO: Acceso VIP
# Instrucciones: Los sets son super rápidos para buscar cosas, pero no tienen orden.
# 1. Intenta verificar si "Julio" está en el set de usuarios (True/False).
# 2. Intenta imprimir el primer usuario usando el índice [0] y mira qué error sale.
